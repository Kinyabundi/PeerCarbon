  ...
  return (
    <div className="min-h-[17rem] min-w-[330px] bg-white rounded-[50px] px-8 py-6">
      <div className="flex justify-between items-center mt-8">
        <DropletIcon />
        <CiSquareMore className="w-8 h-8 ml-3 text-gray-600" />
      </div>
      <div className="mt-8">
        <h2 className="text-md text-gray-900 font-semibold">{projectName}</h2>
        <div className="my-3">
          <p className="text-xs text-gray-500 tracking-wide leading-6">
            {description}
          </p>
        </div>
      ...
      <div className="mt-12">
        ...
        <div className="mt-6">
          <h3 className="text-sm text-semibold text-gray-700">
            {" "}
            % of emissions to offset
          </h3>
          <div className="w-full bg-gray-100 rounded-full  h-2.5 mt-1">
            <div
              className="bg-[#05c168] h-2 rounded-full"
              style={progressBar}
            ></div>
          </div>
          <div className="my-6">
